...
| session | 2.4.0 | session | start/debrief/retrospective/handover/end + handover-reviewer agent |
...
| claude-user-communication | 0.8.0 | communication | HTML ページ提示 (claude-html-communication) + 選択肢形式の確認 + 生成ページの機械検査 3 層。要環境変数 (plugin README) |
