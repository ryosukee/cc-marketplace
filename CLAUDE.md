...
| session | 2.3.1 | session | start/debrief/retrospective/handover/end + handover-reviewer agent |
...
| japanese-text-writing | 0.1.0 | authoring | 日本語テキストの執筆規範 (共通原則 + 5 分類の references) |
