...
| session | 2.3.3 | session | start/debrief/retrospective/handover/end + handover-reviewer agent |
...
| claude-user-communication | 0.2.4 | communication | HTML ページ提示 (claude-html-communication) + 選択肢形式の確認。要環境変数 (plugin README) |
