...
4. README に記載した対応コーディングエージェント、requirements、setup 方法、未 setup 時の挙動を更新する
...
9. `claude plugins marketplace update agent-plugins-marketplace`
10. `claude plugins update {plugin}@agent-plugins-marketplace`
...
4. `git commit` + `git push`、`claude plugins marketplace update agent-plugins-marketplace`、
   `claude plugins uninstall {plugin}@agent-plugins-marketplace`
