...
4. README の対応ホスト、requirements、setup、未 setup 時の挙動を更新する
5. shared plugin は Claude Code と Codex の両方で動作を確認する
6. agent の定義原本を変えた場合は Claude Code / Codex adapter を両方再生成する
7. shared hook を追加した場合は、同じ処理を行う既存 hook の置き換え要否を確認する
