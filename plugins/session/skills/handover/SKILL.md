...
- **却下**: やらないと決めたもの。「却下と決めたこと」セクションに、
  決めた内容と決めた回だけを書く。復元タスクにも「やり残し・拾い残し」にも入れない。
  次セッションが同じ候補を蒸し返さないための記録で、やることの一覧ではない
- **破棄**: 検討そのものが無効になったもの。handover に含めない

却下と破棄の違いは、次セッションが再提案しうるかどうか。
再提案しうるなら却下として残し、しえないなら破棄する。
